...
ALTER TABLE service_workplace
    ADD CONSTRAINT fk_serwor_on_service_entity FOREIGN KEY (service_id) REFERENCES service_entity (id);

ALTER TABLE service_workplace
    ADD CONSTRAINT fk_serwor_on_workplace FOREIGN KEY (workplace_id) REFERENCES workplace (id);